...
console.log("Corvette é uma submarca da Chevrolet, por isso Chevy" + carro.marca)
...
console.log("Os cilindros são responsáveis por maiores rpms, portanto, maior potência, são encontrados no cabeçote do motor" + carro.cilindros)
